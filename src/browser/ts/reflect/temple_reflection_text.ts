import { ResourceTree, ResourceInstance } from "../code/resource_tree.js";
import { TempleReflection } from "./temple_reflection.js";
...
class TempleReflectionText {
    ...
    describeFocusField(field:TempleFieldBase|null):string {
        if (!field) {
